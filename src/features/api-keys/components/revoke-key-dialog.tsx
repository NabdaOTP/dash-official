...
import { revokeApiKey } from "@/features/projects/services/project-service";
...
export function RevokeKeyDialog({
    ...
    const handleRevoke = async () => {
        ...
        try {
            ...
            toast.error(
                (err as { message?: string })?.message ?? "Failed to revoke API key"
            );
        } finally {
            setLoading(false);
        }
                ...
                <div className="p-5 space-y-4">
                    ...
                    <div className="bg-red-50 border border-red-200 rounded-lg p-3">
                        <p className="text-[12px] text-red-900 leading-relaxed">
                            Any application or service using this key will immediately lose
                            access. You&apos;ll need to update them with a new key.
                        </p>
                    </div>
