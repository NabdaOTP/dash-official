        ...
        <div className="flex items-start justify-between gap-4 flex-wrap mb-5">
          <div>
            <div className="inline-flex items-center gap-2 rounded-full border border-emerald-200 bg-emerald-50 px-3 py-1 text-[11px] font-semibold text-emerald-700">
              ...
              Shared Meta WhatsApp credentials
            </div>
            <h2 className="mt-3 text-base font-semibold text-foreground">
              Save one test sender bundle for all projects
            </h2>
            <p className="text-[12px] text-muted-foreground mt-0.5 max-w-2xl">
              Store the Meta business, WABA, phone number, and access token here
              once. Every project will read the same shared config for
              templates, OTP, and message sends.
            </p>
          </div>
        ...
        <div className="mt-4 flex flex-wrap items-center gap-3">
          ...
          {metaWhatsapp?.wabaId ? (
            <span className="text-[12px] text-muted-foreground">
              Saved sender will be used by the WABA, templates, and message
              screens.
            </span>
          ) : null}
        </div>
